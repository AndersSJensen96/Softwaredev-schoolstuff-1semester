...
from CustomShapely import ShapelyAnnotation, box, get_shapely_multipolygon
...
def remove_invalid_coco_results(result_list_or_path: Union[List, str],
                                dataset_dict_or_path: Union[Dict, str] = None):
    """
